...
{
	left_side_bar_background.setSize(sf::Vector2f(300, 500));
	...
	left_side_bar_background.setPosition(left_side_bar_background.getSize().x / 2 + 20, left_side_bar_background.getSize().y / 2 + 80);
}
